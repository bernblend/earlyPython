...
# The table should be a dictionary that contains every letter found in
# this text and the count of how many of the characters is present in
# the text.
...
# First make a function that takes in a string and returns a Dictionary
# of all of the characters in the string.
def find_character_count_dict(some_string):
    character_count_dict = {}    # Empty dictionary.
    while some_string:
        ...
        if current_char in character_count_dict:
            ...
            character_count_dict[current_char] = 1
        some_string = some_string[1:]     # Cut string down by one.
